import { DATA, isDemo, load, GAME_PART, partsList } from '../resources';
...
const vm = {
  ...
  [OP_CODE.condJmp]() {
    ...
    DEBUG &&
      console.info(
        'VirtualMachine::op_condJmp(%i, %i, %i, %i)',
        op,
        b,
        a,
        addr
  ...
  [OP_CODE.resetThread]() {
    ...
    DEBUG &&
      console.info(
        'VirtualMachine::op_resetThread(%i, %i, %i)',
        start,
        end,
        state
      );
  ...
  [OP_CODE.fillVideoPage]() {
    ...
    DEBUG &&
      console.info('VirtualMachine::op_fillVideoPage(%i, %i)', num, color);
  ...
  [OP_CODE.drawString]() {
    ...
    DEBUG &&
      console.info(
        'VirtualMachine::op_drawString(%i, %i, %i, %i)',
        num,
        x,
        y,
        color
  ...
  [OP_CODE.playSound]() {
    ...
    DEBUG &&
      console.info(
        'VirtualMachine::op_playSound(%i, %i, %i, %i)',
        num,
        freq,
        volume,
        channel
  ...
  [OP_CODE.playMusic]() {
    ...
    DEBUG &&
      console.info(
        'VirtualMachine::op_playMusic(%i, %i, %i)',
        num,
        period,
        position
      );
